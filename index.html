<html>
<center><audio autoplay="autoplay" controls="controls" width="128px" height="30px"><source src="https://api.soundcloud.com/tracks/65978056/stream?client_id=a3e059563d7fd3372b49b37f00a00bcf"></audio>
<script>
<head>
<title>Mr.P4tRiCk</title>
...
<font color="red" size="7" face="Chicle">Hacked By Mr.P4tRiCk
<center>
</font><br> No Sytem Is Save!! <br> Fuck You !!
<img style="width:50%" src="http://i63.tinypic.com/2z9issm.jpg"></div>
<font color=white>
<br> 
<b><font face="courier new" size='6'>[+] ^^ Sorry Admin ^^ [+] <br> Saya Hanya Mengingatkan Bahwa <br> Sistem Yang Anda Miliki <br> Tidak Aman <br> Amankan Sistem Anda Sekarang <br>  | Sekali Lagi Amankan | <br> We Are Anonymous Indonesia
...
<div style="text-shadow: 0px 0px 10px green;"><span style="color: white;"><font face="transformers"><b>Thanks To : <marquee scrollamount="5" direction="left" width="50%"><span style="color: red;"> <span style="color: red;">Mr.P4tRiCk || Jawa Cyber<span style="color: red;"></b></marquee></font></div><script type="text/rocketscript">/*<![CDATA[*/new TypingText(document.getElementById("message"), 90, function(i){ var ar= new Array("_", " ", "_", " "); return "" +ar[i.length % ar.length]; });//Type out examples:TypingText.runAll();/*]]>*/</script>
<marquee behavior="scroll" direction="right" scrollamount="90" scrolldelay="40" width=	%">
